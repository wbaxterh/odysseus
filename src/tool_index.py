...
ASSISTANT_ALWAYS_AVAILABLE = frozenset({
    ...
    "resolve_contact", "search_chats", "search_knowledge",
...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "search_knowledge": "Search the user's knowledge base of ingested Teams chats and documents (semantic RAG). Use for questions about team conversations, what a colleague said, reported, decided, or worked on, project history, meeting follow-ups, status reports, or any fact from ingested chats and documents rather than this app's own sessions.",
