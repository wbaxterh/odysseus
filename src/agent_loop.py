...
_DOMAIN_TOOL_MAP = {
    ...
    "ui": {"ui_control"},
    "sessions": {"create_session", "list_sessions", "manage_session", "send_to_session", "search_chats", "search_knowledge"},
...
`calendar` accepts a name ("Main") or short-id prefix.""",
    ...
    "search_knowledge": "- ```search_knowledge``` — Semantic search over the user's KNOWLEDGE BASE (ingested Teams chats + documents). Line 1 = natural-language query. Use when the user asks what a colleague said/reported/decided, about team conversations, project history, or facts from ingested chats/docs — NOT for this app's own sessions (that's search_chats). Returns evidence snippets with sources and dates; cite them in your answer.",
